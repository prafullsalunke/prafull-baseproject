...
## THIS HAS BEEN MODIFIED TO USE SENDEMAIL, so that supervisor uses gmail smtp to send mails.
...
class CrashMail:
    ...
    def runforever(self, test=False):
        while 1:
            ...
            f1 = open('/tmp/tlog', 'w')
            f1.write('YO START')
            sendmyemail = '/usr/bin/sendemail -f trac@glitterbug.in -t ranedk@gmail.com tapan@glitterbug.in -u "%s" -m "%s" -s smtp.gmail.com -o tls=yes -xu trac@glitterbug.in -xp dc45970f' % (subject, msg)
